...
public class Utilities {
    ...
    public javax.swing.DefaultComboBoxModel makeCustomerCombo(java.util.ArrayList<String[]> customers)
    {
        javax.swing.DefaultComboBoxModel model = new javax.swing.DefaultComboBoxModel();
        DataConnection dc = new DataConnection();

        dc.connect();
        customers = dc.getCustomerList();

        try{
            for(int i=0;i<customers.size();i++)
            {
                String[] newLine = customers.get(i);
                String line = newLine[1]; // + " " + newLine[2] + ", " + newLine[3];
                model.addElement(makeObj(line));
            }
    ...
    public javax.swing.DefaultComboBoxModel makeStateCombo()
    {
        javax.swing.DefaultComboBoxModel model = new javax.swing.DefaultComboBoxModel();
        DataConnection dc = new DataConnection();
        java.util.ArrayList<String> states;

        dc.connect();
        states = dc.getStateList();

        try{
            for(int i=0;i<states.size();i++)
            {
                model.addElement(makeObj(states.get(i)));
            }
    ...
    public javax.swing.DefaultComboBoxModel makeCityCombo()
    {
        javax.swing.DefaultComboBoxModel model = new javax.swing.DefaultComboBoxModel();
        DataConnection dc = new DataConnection();
        ...
        dc.connect();
        cities = dc.getCityList();

        try{
            for(int i=0;i<cities.size();i++)
            {
                model.addElement(makeObj(cities.get(i)));
            }
    ...
    public javax.swing.DefaultComboBoxModel makeDistCombo()
    {
        javax.swing.DefaultComboBoxModel model = new javax.swing.DefaultComboBoxModel();
        DataConnection dc = new DataConnection();
        java.util.ArrayList<String> dist;

        dc.connect();
        dist = dc.getDistributerList();

        try{
            for(int i=0;i<dist.size();i++)
            {
                model.addElement(makeObj(dist.get(i)));
            }
